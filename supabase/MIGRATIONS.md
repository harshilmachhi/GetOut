...
| `20260916000000_spot_community.sql` | Original deployed community schema: Circle-aware comments and written reviews, hardened rating writes, and reporting support. |
| `20260917000000_remove_spot_comments.sql` | Product follow-up that removes comments and narrows community participation and reporting to written reviews only. |
