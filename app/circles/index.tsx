...
function Circles() {
  ...
  const create = async () => {
    ...
    try { setBusy(true); const circle = await app.createCircle(name, description); Keyboard.dismiss(); setShowCreate(false); setName(''); setDescription(''); router.push(`/circles/${circle.id}` as never); }
