...
enum PublicSocialError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .noAccount:
            "A GetOut account is required to use public social features."
        case .offline:
...
struct PublicSpotDTO: Equatable, Sendable, Identifiable {
    ...
    init(
        ...
        self.visitWeekday = visitWeekday
...
struct PublicUserProfileDTO: Equatable, Sendable, Identifiable {
    ...
    init(recordName: String, userRecordName: String, username: String, displayName: String, bio: String, avatarSystemImage: String, citiesVisited: [String] = [], preferredCategories: [String] = [], preferredTags: [String] = [], createdAt: Date) {
        self.recordName = recordName; self.userRecordName = userRecordName; self.username = username
        self.displayName = displayName; self.bio = bio; self.avatarSystemImage = avatarSystemImage
        self.citiesVisited = citiesVisited; self.preferredCategories = preferredCategories; self.preferredTags = preferredTags; self.createdAt = createdAt
    }
